...
CREATE TABLE employees (
  ...
  team_id INT,
  -- FOREIGN KEY (team_id) REFERENCES teams (id) ON DELETE CASCADE -- Mysql 
...
--  *lesson 132 talks about using composite keys as a foreign key since the above is a composite key of primary keys
